...
SCHEMAS = Path(__file__).resolve().parents[3] / "config" / "discovery_schemas"
PROFILE_SCHEMA_PATH = SCHEMAS / "paper_profile.graph_input.schema.json"
GRAPH_SCHEMA_PATH = SCHEMAS / "research_graph.schema.json"
GRAPH_BUILD_MANIFEST_SCHEMA_PATH = SCHEMAS / "graph_build_manifest.schema.json"
