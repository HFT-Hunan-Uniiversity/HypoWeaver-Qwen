...
from .schema_gate import require_valid_instance
from .research_graph import validate_graph
...
GENERATOR = "hypoweaver/discovery_engine/builder.py@1.0.0"
...
def _derivation(
    *,
    ...
    return {
        ...
        "code_ref": "hypoweaver/discovery_engine/builder.py",
    }
